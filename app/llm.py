...
TOOL_LOOP_SYSTEM = (
    ...
    "  GitHub (site:github.com), GitLab (site:gitlab.com), Bitbucket (site:bitbucket.org), "
    "LinkedIn X-ray (site:linkedin.com/in, public snippets only - never log in), "
    "Indeed public resumes (site:indeed.com/resumes), Wellfound (site:wellfound.com/profile), and by role: "
    "Stack Overflow users, Kaggle, Behance/Dribbble.\n"
    ...
    "linkedin.com/in/..., wellfound.com/profile/..., "
